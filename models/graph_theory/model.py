...
def training(net, train_loader, val_loader, train_y_mean, train_y_std, val_monitor_epoch = 10, n_forward_pass = 5, device = torch.device("cpu")):
...
def inference(net, test_loader, train_y_mean, train_y_std, n_forward_pass = 30, device = torch.device("cpu")):
