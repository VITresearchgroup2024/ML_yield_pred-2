...
column_name = 'coupling_partner'  # Replace with the actual column name
...
output_csv_path = f'D:/Reaction optimization project/source code/DFT/opti/{column_name}/{column_name}.csv'
