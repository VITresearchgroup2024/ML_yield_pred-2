...
display_df.to_csv("D:/Reaction optimization project/source code/RDkit_FP/result/random_split_fp_descriptors_test_size_0.2_dataset1.8.csv")
#%%

import visualization as vs

csv_file = "D:/Reaction optimization project/source code/RDkit_FP/result/random_split_fp_descriptors_test_size_0.2_dataset1.8.csv"
image_path = 'D:/Reaction optimization project/source code/RDkit_FP/result/random_split_drfp_descriptors_test_size_0.2_dataset1.8.png'
vs.visualization(csv_file, image_path)
#%%
#2.substrate split

values, global_baseline_results, global_results, stratification_results, additional_stratification_results = an.stratified_split(X_fp, y_fp, list(dataset["substrate"]), origins_fp,metric=metric, predictor=RandomForestRegressor(), test_size=0.2, 
                                                                                                                              n_iterations=10)
