...
display_df.to_csv("D:/Reaction optimization project/source code/DFT/results/random_split_dft_descriptors_test_size_0.2.csv")

#%%
import visualization as vs
csv_file = "D:/Reaction optimization project/source code/DFT/results/random_split_dft_descriptors_test_size_0.2.csv"
image_path = 'D:/Reaction optimization project/source code/DFT/results/random_split_dft_descriptors_test_size_0.2.png'
